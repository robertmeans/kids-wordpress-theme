...
if ( ! function_exists( 'stanton_and_meredith_pagination' ) ) :
/**
 * Display navigation to next/previous set of posts when applicable.
 *
 * @todo Remove this function when WordPress 4.3 is released.
 */
function stanton_and_meredith_pagination() {
	...
	$links = paginate_links( array(
		...
		'prev_text' => __( '← Previous', 'stanton-and-meredith' ),
		'next_text' => __( 'Next →', 'stanton-and-meredith' ),
        'type'      => 'list',
	) );
	...
	<nav class="navigation paging-navigation" role="navigation">
		<h1 class="screen-reader-text"><?php esc_html_e( 'Posts navigation', 'stanton-and-meredith' ); ?></h1>
			<?php echo $links; ?>
	</nav><!-- .navigation -->
	<?php
	endif;
